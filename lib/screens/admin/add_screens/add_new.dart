...
class AddNewCourseSS extends StatefulWidget {
  AddNewCourseSS({super.key});

  @override
  State<AddNewCourseSS> createState() => _AddNewCourseSSState();
}

class _AddNewCourseSSState extends State<AddNewCourseSS> {
