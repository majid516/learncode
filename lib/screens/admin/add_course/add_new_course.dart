...
// // void chekWeb()async{
// //   if(kIsWeb){
// //    await pickweb.loadLibrary();
// //   }else{
// //     await pickmobile.loadLibrary();
// //   }
// // }
// class AddNewCourse extends StatefulWidget {
//   final VoidCallback onCourseAdded;
//   final int? Function() submitFuntion;

//   AddNewCourse({
//     super.key,
//     required this.onCourseAdded,
//     required this.submitFuntion, // Callback required
//   });
...
//   // Decide which pages to load based on platform
...
//     }
//     if (AddCourseThumbnail.thumbnail == null) {
//       showErrorDialog('Thumbnail is required');
//       return;
//     }
//     if (!kIsWeb && AddCourseDetails.pickedVideo == null ||
//         kIsWeb && AddCourseDetailsWeb.pickedVideo == null
//         ) {
//       showErrorDialog('Video is required');
//       return;
//     }
